...
Several questions are directly removed during the categorizing process. We have removed question 3, 4b, 4h, 14, 15, 16, 24, 25 from the teacher's survey either because it's not particularly relevant to survey questions from students' and parents' perspective, or due to significant amount of NAs. Questions 5d, 5e, 7, 8, 9, 10 are removed from the parents datasets due to similar reasons or because some questions are tageted to specific populations (eg. pre-k, high school)
